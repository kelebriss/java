...
public class Ore implements Serializable // can do serializing (one of container class)
{										 // in OrePile can make object of Ore stream so make in Oreclass and import it
	...
	public void save(DataOutputStream dataStrm) throws IOException
	{
		dataStrm.writeChar(oreType);
		dataStrm.writeUTF(units);
	}
	public void load (DataInputStream dataStrm) throws IOException
	{
		this.oreType = dataStrm.readChar();
		this.units = dataStrm.readUTF();
	}
}
